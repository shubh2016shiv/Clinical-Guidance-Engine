...
class ResponsesAPIError(OpenAIResponsesError):
    ...
    def __init__(self, status_code=None, error_type=None, message="OpenAI Responses API returned an error"):
        self.status_code = status_code
        self.error_type = error_type
        error_info = f" (Status: {status_code}, Type: {error_type})" if status_code else ""
